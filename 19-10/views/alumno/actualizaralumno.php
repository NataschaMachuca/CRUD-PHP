...
print'
        ...
        <label class="label">  </label>
        <input type="text" value="'. $data['NOMBRE']. '" name="nuevoNombre" id="nuevoNombre" required="" placeholder="Escriba su Nombre"> <br>

        <label class="label">  </label>
        <input type="text"  value="'. $data['APELLIDO']. '" name="nuevoApellido" id="nuevoApellido" placeholder="Escriba su Apellido"> <br>

        <label class="label">  </label>
        <input type="email"  value="'. $data['CORREO']. '" name="nuevoCorreo" id="nuevoCorreo"  placeholder="Escriba su Correo"> <br>
