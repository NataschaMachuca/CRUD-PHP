...
<head>
  ...
  <div class='collapse navbar-collapse' id='navbarSupportedContent'>
    ...
    <li class='nav-item active'>
      <a class='nav-link' href='../ejercicio_2.php'> INICIO <span class='sr-only'>(current)</span></a>
    </li>

    <li class='nav-item active'>
      <a class='nav-link' href='../19-10/views/aprendiz.php'> APRENDIZ <span class='sr-only'>(current)</span></a>
    </li>

    <li class='nav-item active'>
      <a class='nav-link' href='../19-10/views/coordinador.php'> COORDINADOR <span class='sr-only'>(current)</span></a>
    </li>

      <li class='nav-item active'>
        <a class='nav-link' href='../19-10/views/novedad.php'> NOVEDAD <span class='sr-only'>(current)</span></a>
      </li>
    </ul>
